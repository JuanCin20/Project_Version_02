...
-- SELECT Fecha_Boleta_Venta, COUNT(Fecha_Boleta_Venta) AS Sale_Number FROM Tabla_Boleta_Venta WHERE STR_TO_DATE(Fecha_Boleta_Venta, '%d/%m/%Y') BETWEEN STR_TO_DATE('21/03/2025', '%d/%m/%Y') AND STR_TO_DATE('23/03/2025', '%d/%m/%Y') GROUP BY Fecha_Boleta_Venta;
